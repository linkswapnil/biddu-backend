  ...
  export const CONFIG = {
    ...
    BIDDU_CATEGORIES_TABLE: getEnv("BIDDU_CATEGORIES_TABLE"),
    BIDDU_SUBCATEGORIES_TABLE: getEnv("BIDDU_SUBCATEGORIES_TABLE"),
    BIDDU_PRODUCT_IMAGES_BUCKET: getEnv("BIDDU_PRODUCT_IMAGES_BUCKET"),
    TWILIO: {
